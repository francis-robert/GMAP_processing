rawdataprep <- function(path){
  ...
  if(length(data_MA) == 0){
    ...
    #read in line 2 column 13 (characters) and mutate to a column. if make mistake and it is blank, can put in something that is unique and then can handle it later
